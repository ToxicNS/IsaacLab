...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": f"{__name__}.lift_joint_pos_env_cfg:FrankaReachEnvCfg",
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.lift_joint_pos_env_cfg:FrankaReachEnvCfg_PLAY",
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_cfg.yaml",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:FrankaReachPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_ppo_cfg.yaml",
    },
...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.lift_ik_rel_env_cfg:FrankaReachEnvCfg",
    },
    disable_env_checker=True,
)
